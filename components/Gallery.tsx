    ...
    <section className="py-20 bg-white relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            {/* Left Side: Visual Illustration (CSS Only) */}
            <div className="relative h-96 w-full rounded-[40px] bg-ocean-gradient overflow-hidden shadow-2xl flex items-center justify-center group">
                {/* Decorative Circles */}
                ...
                <div className="text-center text-white relative z-10 p-8">
                    ...
                    <button className="mt-8 bg-white text-blue-600 font-bold py-3 px-8 rounded-full hover:scale-105 transition-transform shadow-lg">
                        Falar no WhatsApp
                    </button>
                </div>
