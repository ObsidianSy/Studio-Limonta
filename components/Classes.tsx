...
const CLASS_ICONS: Record<string, React.ReactNode> = {
  ondinha: <span className="text-5xl" role="img" aria-label="Ondinha">〰️</span>,
  bolhinha: <span className="text-5xl" role="img" aria-label="Bolhinha">🫧</span>,
  correnteza: <span className="text-5xl" role="img" aria-label="Correnteza">🌀</span>,
  mare: <span className="text-5xl" role="img" aria-label="Maré">🌊</span>,
  rio: <span className="text-5xl" role="img" aria-label="Rio">🏞️</span>,
  cachoeira: <span className="text-5xl" role="img" aria-label="Cachoeira">💦</span>,
  tsunami: <span className="text-5xl" role="img" aria-label="Tsunami">🏄</span>,
  oceano: <span className="text-5xl" role="img" aria-label="Oceano">🌏</span>,
};
